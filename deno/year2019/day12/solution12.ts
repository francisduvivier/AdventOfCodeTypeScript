...
assertEquals(part1(testInput2.map(copyMoon), 100), sum([290, 608, 574, 468]));

logAndPushSolution(part1(input.map(copyMoon)), solutions);
assertEquals(solutions, [10635]);
...
assertEquals(findLCM(part2TestPoint3.col, part2TestPoint3.z, part2TestPoint3.row), 4686774924);
...
assertEquals(solutions, [10635, 583523031727256]);
