export const rInput = `light red bags contain 1 bright white bag, 2 muted yellow bags.
...
export const tInput = `muted white bags contain 4 dark orange bags, 3 bright white bags.
