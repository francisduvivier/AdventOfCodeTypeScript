...
import { anyTruthy, sum } from "../../year2019/util/MapReduce";

const rInput = fs.readFileSync('./src/year2020/day7/input.txt', { encoding: 'UTF8' });
const tInput = fs.readFileSync('./src/year2020/day7/testinput.txt', { encoding: 'UTF8' });
